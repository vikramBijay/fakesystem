      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            color: '#a78bfa', letterSpacing: '.1em', textTransform: 'uppercase',
          }}>
            🎵 Choose a Track
          </span>
          <button
            ...
            style={{
              ...
              color: '#6b6890', fontSize: '1.1rem', lineHeight: 1,
            ...
            return (
              ...
              >
                    ...
                    <span style={{ display: 'flex', alignItems: 'flex-end', gap: '2px', height: '14px' }}>
                      {[1, 1.7, 0.9, 1.4].map((h, i) => (
                        <span key={i} style={{
                          ...
                          height: `${8 * h}px`, background: '#fff',
                          borderRadius: '2px',
                          animation: `soundBar ${0.4 + i * 0.13}s ease-in-out infinite alternate`,
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{
                    fontSize: '.72rem', color: '#6b6890', marginTop: '2px',
                    whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
                  }}>
                    {song.artist}
                  </div>
                ...
                {active && (
                  <span style={{
                    fontSize: '.65rem', fontWeight: 700, color: '#a78bfa',
...
export default function HomePage({
  ...
  return (
    <div style={{
      ...
      {/* ── z2: FADES ── */}
      <div style={{ position:'absolute',bottom:0,left:0,right:0,height:'50%',zIndex:2,pointerEvents:'none',background:'linear-gradient(to top,#080818 0%,#080818 15%,rgba(8,8,24,0.65) 45%,transparent 100%)' }} />
      <div style={{ position:'absolute',top:0,bottom:0,left:0,width:'22%',zIndex:2,pointerEvents:'none',background:'linear-gradient(to right,#080818 0%,transparent 100%)' }} />
      <div style={{ position:'absolute',top:0,bottom:0,right:0,width:'22%',zIndex:2,pointerEvents:'none',background:'linear-gradient(to left,#080818 0%,transparent 100%)' }} />
      <div style={{ position:'absolute',top:0,left:0,right:0,height:'22%',zIndex:2,pointerEvents:'none',background:'linear-gradient(to bottom,#080818 0%,transparent 100%)' }} />

      {/* ── z4: EYEBROW PILL ── */}
      <div style={{ position:'absolute',top:'80px',left:0,right:0,zIndex:4,display:'flex',justifyContent:'center',pointerEvents:'none',animation:'fadeUp .5s ease .1s both' }}>
        <div style={{ display:'inline-flex',alignItems:'center',gap:'8px',background:'rgba(139,92,246,0.1)',border:'1px solid rgba(139,92,246,0.3)',padding:'5px 18px',borderRadius:'999px',fontSize:'.67rem',color:'#a78bfa',fontWeight:600,letterSpacing:'.12em',textTransform:'uppercase' }}>
